...
//	private static final Logger logger = LoggerFactory.getLogger(LunarToSolarUtil.class);
	// 计算阴历日期参照1900年到2049年
	...
	public static String solarToLunar(String solarDate) throws Exception{
		...
		return lunarYear+"年"+(leapMonthFlag&(lunarMonth==leapMonth)?"闰":"")+lunarMonth+"月"+(lunarDay <= 10 ? "初" + lunarDay : lunarDay);
	}
